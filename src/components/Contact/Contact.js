...
import './Contact.css';
import contactsOrange from './../../assets/img/contactsOrange.75754594.svg'

function Contact() {
    return ( 
        <>
            <Container>
                <div className='about_contcat_container'>
                    <div className='paddingTop4rem'>
                        <Row>
                            <Col>
                                <TopicHeading headingText={'Contact Us'} />
                            </Col>
                        </Row>
                        <Row>
                            <Col >
                                <div className="contacts" id="contacts" >
                                    <div className="contacts--container">
                                        <div className="contacts-body">
                                            <div className="contacts-form">
                                                <form>
                                                    <div className="input-container">
                                                        <label for="Name" className="jss89">Name</label>
                                                        <input placeholder="John Doe" type="text" name="Name" className="form-input jss87" value="" />
                                                    </div>
                                                    <div className="input-container">
                                                        <label for="Email" className="jss89">Email</label>
                                                        <input placeholder="John@doe.com" type="email" name="Email" className="form-input jss87" value="" />
                                                    </div>
                                                    <div className="input-container">
                                                        <label for="Message" className="jss89">Message</label>
                                                        <textarea placeholder="Type your message...." type="text" name="Message" className="form-message jss88"></textarea>
                                                    </div>
                                                    <div className="submit-btn">
                                                        <button type="submit" className="jss92">
                                                            ...
                                                            <div className="submit-icon">
                                                                ...
                                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" className="success-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" >
                                            ...
                                            <div className="contacts-details">
                                                <a href="mailto:janedoe.test@gmail.com" className="personal-details">
                                                    <div className="jss91">
                                                ...
                                                <div className="personal-details">
                                                    ...
                                                    <p >Menlo Park, California, United States - 673822 </p>
                                                </div>
                                                <div className="socialmedia-icons">
                                                    <a href="https://twitter.com/" target="_blank" rel="noreferrer" className="jss90">
                                                    ...
                                                    <a href="https://github.com/" target="_blank" rel="noreferrer" className="jss90">
                                                    ...
                                                    <a href="https://www.linkedin.com/in" target="_blank" rel="noreferrer" className="jss90">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path>
                                                        </svg>
                                                    </a>
                                                    <a href="https://www.instagram.com/" target="_blank" rel="noreferrer" className="jss90">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a href="https://medium.com/@" target="_blank" rel="noreferrer" className="jss90">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a href="https://www.blogger.com/" target="_blank" rel="noreferrer" className="jss90">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a href="https://youtube.com/" target="_blank" rel="noreferrer" className="jss90">
                                                    ...
                                                    <a href="https://www.reddit.com/user/" target="_blank" rel="noreferrer" className="jss90">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a href="https://stackoverflow.com/users/" target="_blank" rel="noreferrer" className="jss90">
                                                    ...
                                                    <a href="https://codepen.io/" target="_blank" rel="noreferrer" className="jss90">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a href="https://gitlab.com/" target="_blank" rel="noreferrer" className="jss90">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {/* <img src={contactsOrange} alt="contacts" className="contacts--img" /> */}
                                </div>
                            </Col>
                        </Row>
                    </div>
